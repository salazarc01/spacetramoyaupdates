...
const STORAGE_KEY = 'spacetramoya_posts_v10';
const LAST_GEN_KEY = 'spacetramoya_last_gen_window_v10';
...
const App: React.FC = () => {
  ...
  return (
    <div className={`min-h-screen font-sans text-slate-100 flex flex-col items-center ${showCarousel ? 'h-screen overflow-hidden' : ''}`}>
      {/* Header con Z-Index alto para que el menú esté por encima del fondo oscuro */}
      ...
      {/* Backdrop para cerrar el menú (Z-Index justo debajo del header) */}
      {isMenuOpen && (
        <div 
      ...
      {/* Carrusel de Candidatas (Capa Superior) */}
      {showCarousel && (
        <CandidateCarousel 
